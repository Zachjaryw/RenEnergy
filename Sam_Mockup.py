...
with primark.expander("Introduction"):
...
with primark.expander('Goals'):
  with primark.expander('Product'):
...
with primark.expander('Carbon Footprint'):
...
with primark.expander('Climate Activists Groups'):
  primark.write('''
...
with primark.expander('Other Actions Taken'):
...
with lulu.expander('Introduction'):
